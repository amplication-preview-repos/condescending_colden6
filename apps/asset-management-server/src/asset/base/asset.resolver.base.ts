...
export class AssetResolverBase {
  ...
  async createAsset(@graphql.Args() args: CreateAssetArgs): Promise<Asset> {
    return await this.service.createAsset({
      ...
      data: {
        ...
        assetHierarchy: args.data.assetHierarchy
          ? {
              connect: args.data.assetHierarchy,
            }
          : undefined,
      },
    });
  ...
  async findAasxes(
    ...
    const results = await this.service.findAasxes(parent.id, args);
  ...
  async getAssetHierarchy(
    ...
    const result = await this.service.getAssetHierarchy(parent.id);
